...
#Tabs: https://dash.plotly.com/dash-core-components/tabs
    html.Div([
      dcc.Tabs(id='tabs', value='learn', children=[
         dcc.Tab(label='mean_deviatoric', value='mean_deviatoric'),
         dcc.Tab(label='sigam1_sigma3', value='sigam1_sigma3'),
      ]),
...
def update_graph(circle_checkbox, coulomb_checkbox, s_m, s_d, s_o, mu,):
...
#FIX THIS SO IT PLOTS END POINT ON THE CIRCLE BASED ON A CHOSEN ANGLE FOR THETA.
